...
datos |>
  ...
  geom_abline(slope =-0.9159786, intercept = 4.149884,linetype="dashed", color = "black", linewidth = 0.7)+
  geom_abline(slope =-0.89, intercept = 4,linetype="dashed", color = "black", linewidth = 0.7)+
  geom_abline(slope =-0.93, intercept = 3.5,linetype="dashed", color = "black", linewidth = 0.7)+
  geom_abline(slope =-0.72, intercept = 3.7,linetype="dashed", color = "black", linewidth = 0.7)
